// RALD PayRald API — JWT utilities (CF Worker / Web Crypto)
...
export interface JwtPayload {
  ...
  country?: string | null; iat: number; exp: number;
}
...
export async function signMachineJwt(secret: string, service = "payrald-api"): Promise<string> {
